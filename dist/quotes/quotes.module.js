...
const quotes_gateway_1 = require("./quotes.gateway");
const quotes_service_1 = require("./quotes.service");
let QuotesModule = class QuotesModule {
};
QuotesModule = __decorate([
    (0, common_1.Module)({
        exports: [quotes_gateway_1.QuotesGateway],
        providers: [quotes_gateway_1.QuotesGateway, quotes_service_1.QuotesService],
    })
], QuotesModule);
